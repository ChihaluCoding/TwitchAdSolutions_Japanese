*English / [日本語](DEBUG.ja.md)*

# Debugging TwitchAdSolutions

> **Note:** the scripts in this fork log in Japanese. The console messages quoted below are the
> original English wording and no longer match the output — see [DEBUG.ja.md](DEBUG.ja.md) for the
> messages the scripts actually print. The `[AD DEBUG]` prefix is unchanged.
